...
<body>
    ...
    <form action="{{ route('inventory.store') }}" method="POST">
        ...
        <br>
        <input type="number" id="initial_quantity" name="initial_quantity" step="0.001" min="0" max="9999999999" value="{{ old('initial_quantity') }}" required>
        ...
        <br>
        <input type="number" id="current_quantity" name="current_quantity" step="0.001" min="0" max="9999999999" value="{{ old('current_quantity') }}" required>
        ...
        <label>
            <input type="checkbox" name="safety_classes[]" value="{{ $class->value }}" @checked(in_array($class->value, old('safety_classes', [])))>
            {{ $class->value }}
        </label><br>
        @endforeach
        ...
        <label>
            <input type="checkbox" name="ghs_symbols[]" value="{{ $class->value }}" @checked(in_array($class->value, old('ghs_symbols', [])))>
            {{ $class->value }}
        </label><br>
        @endforeach
