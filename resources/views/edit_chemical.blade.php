...
<body>
    ...
    <form action="{{ route('inventory.update', $chemical->chemical_id) }}" method="POST">
        ...
        <br>
        <input type="number" id="location_id" name="location_id" value="{{ old('location_id', $chemical->location_id) }}"
            required>
        ...
        <input type="text" id="chemical_name" name="chemical_name"
            value="{{ old('chemical_name', $chemical->chemical_name) }}" required>
        ...
        <input type="text" id="batch_number" name="batch_number"
            value="{{ old('batch_number', $chemical->batch_number) }}" required>
        ...
        <br>
        <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name', $chemical->brand_name) }}"
            required>
        ...
        <input type="number" id="volume_per_unit" name="volume_per_unit" step="0.001" min="0" max="9999999999"
            value="{{ old('volume_per_unit', $chemical->volume_per_unit) }}" required>
        ...
        <input type="number" id="initial_quantity" name="initial_quantity" step="0.001" min="0"
            max="9999999999" value="{{ old('initial_quantity', $chemical->initial_quantity) }}" required>
        ...
        <input type="number" id="current_quantity" name="current_quantity" step="0.001" min="0"
            max="9999999999" value="{{ old('current_quantity', $chemical->current_quantity) }}" required>
        ...
        <input type="date" id="expiration_date" name="expiration_date"
            value="{{ old('expiration_date', $chemical->expiration_date) }}" required>
        ...
        <input type="date" id="arrival_date" name="arrival_date"
            value="{{ old('arrival_date', $chemical->arrival_date) }}" required>
        ...
        @foreach (\App\SafetyClass::cases() as $class)
            <label>
                <input type="checkbox" name="safety_classes[]" value="{{ $class->value }}"
                    @checked(in_array($class->value, $selected_safety_classes))>
                {{ $class->value }}
            </label><br>
        @endforeach
