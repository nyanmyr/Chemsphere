...
<body>
    ...
    <form action="{{ route('inventory.update', $chemical->chemical_id) }}" method="POST">
        ...
        <br>
        <input type="number" id="location_id" name="location_id" value="{{ old('location_id', $chemical->location_id) }}" required>
        ...
        <br>
        <input type="text" id="chemical_name" name="chemical_name" value="{{ old('chemical_name', $chemical->chemical_name) }}" required>
        ...
        <br>
        <input type="text" id="batch_number" name="batch_number" value="{{ old('batch_number', $chemical->batch_number) }}" required>
        ...
        <br>
        <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name', $chemical->brand_name) }}" required>
        ...
        <br>
        <input type="number" id="volume_per_unit" name="volume_per_unit" step="0.001" min="0" max="9999999999" value="{{ old('volume_per_unit', $chemical->volume_per_unit) }}" required>
        ...
        <br>
        <input type="number" id="initial_quantity" name="initial_quantity" step="0.001" min="0" max="9999999999" value="{{ old('initial_quantity', $chemical->initial_quantity) }}" required>
        ...
        <br>
        <input type="number" id="current_quantity" name="current_quantity" step="0.001" min="0" max="9999999999" value="{{ old('current_quantity', $chemical->current_quantity) }}" required>
        ...
        'safety_classes',
        collect($cleaned_safety_classes)->map(fn($c) => is_object($c) ? $c->value : trim($c))->all(),
        );
        @endphp
        ...
        'ghs_symbols',
        collect($cleaned_ghs_symbols)->map(fn($c) => is_object($c) ? $c->value : trim($c))->all(),
        );
        @endphp
