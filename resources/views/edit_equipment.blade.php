...
<body>
    ...
    <form action="{{ route('equipment.update', $equipment->equipment_id) }}" method="POST">
        ...
        <br>
        <input type="number" id="location_id" name="location_id" value="{{ old('location_id', $equipment->location_id) }}" required>
        ...
        <br>
        <input type="text" id="equipment_name" name="equipment_name" value="{{ old('equipment_name', $equipment->equipment_name) }}" required>
        ...
        <br>
        <input type="text" id="model" name="model" value="{{ old('equipment_name', $equipment->model) }}" required>
        ...
        <br>
        <input type="text" id="serial_id" name="serial_id" value="{{ old('serial_id', $equipment->serial_id) }}" required>
